const ValueProps = (props: { data: {features: [{ description: String, img: String, subtitle: String, title: String }], featureSummary: {title: String, subtitle: String}} }) => {
    ...
    return (
        <section id="value-props" className="bg-white dark:bg-gray-900">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div className="max-w-screen-md mb-8 lg:mb-16">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">{featureSummary.title}</h2>
                    <p className="text-gray-500 sm:text-xl dark:text-gray-400">{featureSummary.subtitle}</p>
                </div>
